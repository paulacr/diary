...
import com.paulacr.dreamdiary.ui.BaseAdapter
import com.paulacr.dreamdiary.ui.BaseViewHolder
...
class DreamsListAdapter(
    ...
    fun insertDreamsList(dreams: List<Dream>) {
